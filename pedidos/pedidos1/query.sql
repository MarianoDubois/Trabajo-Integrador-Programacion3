...
>>>>>>> Stashed changes
CREATE
DATABASE if not exists Pedidos;
...
insert into Estados_Venta (nombre, descripcion)
values ("Entregado", "El pedido a sido entregado");
insert into Estados_Venta (nombre, descripcion)
values ("Pendiente", "Su pedido esta en espera");
insert into Estados_Venta (nombre, descripcion)
values ("Confirmado", "Su pedido esta en proceso");
...
insert into Condiciones_Iva (nombre, descripcion)
values ("Responsable Inscripto", "Factura A");
insert into Condiciones_Iva (nombre, descripcion)
values ("Sujeto Externo", "Factura C");
insert into Condiciones_Iva (nombre, descripcion)
values ("Consumidor Final", "Factura B");
...
values ("La Calera", "Miguel de Cervantes 552");
insert into Localidades (nombre, descripcion)
values ("Urca", "Jose de Maturana 1442");
insert into Localidades (nombre, descripcion)
values ("Cerro de las Rosas", "Donaciano del Campillo 1446");
...
insert into Proveedores (cuit, razon_social, id_condicion_iva, id_localidad, calle, numero, telefono, fax)
values (20 - 37858374 - 6, "ByC", 1, 1, "San Martin", 1226, 3518659932, 313414515);
insert into Proveedores (cuit, razon_social, id_condicion_iva, id_localidad, calle, numero, telefono, fax)
values (20 - 38538934 - 5, "Walmart", 2, 2, "Av. Colón", 6051, 3515386642, 313473892);
insert into Proveedores (cuit, razon_social, id_condicion_iva, id_localidad, calle, numero, telefono, fax)
values (20 - 65875375 - 3, "Pepsico", 3, 3, "Xavi", 777, 3518290023, 313492402);
...
insert into Productos (nombre, stock, precio_unidad, id_unidad_medida)
values ("Mayonesa", 120, 176.00, 1);
insert into Productos (nombre, stock, precio_unidad, id_unidad_medida)
values ("Savora", 60, 350.00, 2);
insert into Productos (nombre, stock, precio_unidad, id_unidad_medida)
values ("Pepsi", 300, 418.00, 3);
...
insert into Detalles (id_producto, id_venta, cantidad)
values (1, 1, 50);
insert into Detalles (id_producto, id_venta, cantidad)
values (2, 2, 23);
insert into Detalles (id_producto, id_venta, cantidad)
